...
\begin{outerlist}
\item[] Desenvolvedor de Software C\hfill {\bf 08/2009 -- Atual}
  \begin{innerlist}
...
\item[] Moderador de fórum sobre Flash/ActionScript\hfill {\bf 2004 -- 2005}
  \begin{innerlist}
  \item Moderador da área de Flash/ActionScript no fórum
    \href{http://webtutoriais.com}{webtutoriais.com}
  \end{innerlist}
...
\item[] Programação:
  \begin{innerlist}
  \item C/C++, Python, Autotools, shell scripting, Java, JavaScript, SQL
  \end{innerlist}

\item[] Controles de Versão:
  \begin{innerlist}
  \item Mercurial, Git, SVN
  \end{innerlist}
